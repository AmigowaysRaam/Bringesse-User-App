...
const RevenueScreen = () => {
  ...
  const renderStoreItem = ({ item: store }) => (
    <View style={[styles.cardContainer, { backgroundColor: COLORS[theme].viewBackground }]}>
      <Text style={[poppins.semi_bold.h7, { color: COLORS[theme].textPrimary, marginBottom: wp(3) }]}>
        {store.name}
      </Text>
      <FlatList
...
const styles = StyleSheet.create({
  ...
  productImage: { width: wp(18), height: wp(18), borderRadius: wp(2), marginRight: wp(3), backgroundColor: "#eee" },
