...
export default function SelectLocationScreen() {
    ...
    const renderItem = ({ item }) => (
        <TouchableOpacity
            style={[
                styles.addressCard,
                item.is_default ? styles.defaultAddress : null,
            ]}
            onPress={() => handleSetDefaultAddress(item)} // ✅ Confirm before setting default
        >
            <View style={{ flexDirection: 'row', alignItems: 'center' }}>
                <MaterialCommunityIcons name="home-outline" size={22} color="#000" />
                ...
                <FlatList
                    ...
                    ListEmptyComponent={() => (
                        <><Text style={[poppins.regular.h4, {
                            color: COLORS[useTheme().theme].text, textAlign: 'center', marginTop: wp(10)
...
const styles = StyleSheet.create({
    ...
    optionCard: {
        ...
        borderRadius: 10,
        marginBottom: 10,
        width: wp(40), alignSelf: "flex-end"
    },
    ...
    phoneText: { color: '#666', fontSize: 12, marginTop: 2 },
    addressActions: {
        flexDirection: 'row',
