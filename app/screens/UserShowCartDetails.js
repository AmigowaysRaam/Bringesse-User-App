    ...
    >
      <View style={styles.userInfo}>
        <View style={styles.userTextContainer}>
          ...
          >
            {profileDetails?.primary_address?.address + "," + profileDetails?.primary_address?.location?.replace(/^[A-Za-z0-9\+]+,?\s*/, '').trim() || ''}
          </Text>
        </View>
      </View>
...
export default UserShowCartDetails;
